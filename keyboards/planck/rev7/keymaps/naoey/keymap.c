...
enum planck_layers { _QWERTY, _LOWER, _MOUSE, _RAISE, _ADJUST };
...
[_QWERTY] = LAYOUT_planck_grid(
    ...
    _______, KC_LCTL, KC_LALT, KC_LGUI, LOWER,   MOUSE, KC_SPC,  RAISE,   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT
),
...
[_MOUSE] = LAYOUT_planck_grid(
    _______, _______, MS_BTN1, MS_BTN2, _______, _______, _______, _______, KC_MS_U, _______, _______, _______,
