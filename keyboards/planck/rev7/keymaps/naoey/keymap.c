...
[_QWERTY] = LAYOUT_planck_grid(
    ...
    _______, KC_LCTL, KC_LALT, FUNCTION, KC_LGUI, MOUSE, SYMBOL, KC_SPC,  _______, _______, _______,   _______
),
...
[_NAV] = LAYOUT_planck_grid(
    _______, _______, KC_LALT, _______, _______, _______, _______, KC_PGUP, _______, _______, _______, _______,
